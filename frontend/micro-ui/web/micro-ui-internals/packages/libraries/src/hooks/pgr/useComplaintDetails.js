...
const getDetailsRow = ({ id, service, complaintType }) => ({
  ...
  CS_ADDCOMPLAINT_COMPLAINT_TYPE: complaintType === "" ? `SERVICEDEFS.OTHERS` : complaintType,
  CS_ADDCOMPLAINT_COMPLAINT_SUB_TYPE: service.serviceCode,
  CS_ADDCOMPLAINT_COMPLAINT_SUB_SUB_TYPE:service?.additionalDetail?.subSubcategory,
